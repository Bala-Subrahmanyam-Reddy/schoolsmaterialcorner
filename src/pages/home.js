  ...
  return (
    <div>
      ...
      <div className='container p-8 mx-auto xl:px-0 flex flex-wrap'>
        ...
        <div className='flex items-center justify-center w-full lg:w-1/2'>
          <img
            src='https://nextly.web3templates.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fbenefit-two.1d7648d5.png&w=1080&q=75'
            alt='Hero Illustration'
            loading='eager'
            width='521'
            height='482'
      ...
      <div className='container p-8 mx-auto xl:px-0 !p-0'>
        <div className='w-full max-w-2xl p-2 mx-auto rounded-2xl'>
          <div className='mb-5'>
            <button
              className='flex items-center justify-between w-full px-4 py-4 text-lg text-left text-gray-800 rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-indigo-100 focus-visible:ring-opacity-75 '
        ...
        <div className='grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100  lg:grid-cols-5'>
            ...
            <div className='mt-5'>
              ...
              >
                <img
                  ...
                  decoding='async'
                  data-nimg='1'
                  src='https://nextly.web3templates.com/img/vercel.svg'
                />
              </a>
            </div>
          </div>
          <div>
            <div className='flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0'>
              <a
                className='w-full px-4 py-2 text-gray-500 rounded-md  focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none '
                href='/'
              >
                Product
              </a>
